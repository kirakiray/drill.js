...
utils$1.addDataAttr = utils$1.extractId = void 0;
...
function requireUtils () {
	...
	utils.flattenArray = utils.merge = utils.copyOptions = utils.defaults = utils.clone = utils.copyArray = utils.getLocation = void 0;
	var tslib_1 = require$$0$1;
	/* jshint proto: true */
...
function requireFileManager () {
	...
	fileManager.default = (function (opts, log) {
	    options = opts;
	    logger = log;
	    return FileManager;
	});
...
var hasRequiredLogListener;

function requireLogListener () {
	if (hasRequiredLogListener) return logListener;
	hasRequiredLogListener = 1;
	Object.defineProperty(logListener, "__esModule", { value: true });
	logListener.default = (function (less, options) {
...
var hasRequiredErrorReporting;

function requireErrorReporting () {
	if (hasRequiredErrorReporting) return errorReporting;
	hasRequiredErrorReporting = 1;
	Object.defineProperty(errorReporting, "__esModule", { value: true });
	var tslib_1 = require$$0$1;
	var utils = tslib_1.__importStar(utils$1);
	var browser_1 = tslib_1.__importDefault(requireBrowser());
	errorReporting.default = (function (window, less, options) {
...
function requireCache () {
	...
	cache.default = (function (window, options, logger) {
	    var cache = null;
	    if (options.env !== 'development') {
	        try {
